...
instrs = {"u": {"auipc", "lui"}, "i": {"addi", "ori", "andi", "xori", "sltiu", "slti"}, "r": {"add", "sub", "or", "and", "xor", "sltu", "slt", "sll", "srl", "sra"}, "l": {"lb", "lbu", "lh", "lhu", "lw"}, "sh": {"slli", "srli", "srai"}, "amo": {"amoswap.w", "amoadd.w", "amoxor.w", "amoand.w", "amoor.w", "amominu.w", "amomaxu.w", "amomin.w", "amomax.w", "sc.w"}, "lr": {"lr.w"}, "csr": {"csrrw", "csrrs", "csrrc"}, "csri": {"csrrwi", "csrrsi", "csrrci"}}
